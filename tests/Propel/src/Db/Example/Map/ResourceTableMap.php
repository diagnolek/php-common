...
class ResourceTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Db.Example.Map.ResourceTableMap';
     ...
     */
    public const TABLE_PHP_NAME = 'Resource';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Db\\Example\\Resource';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Db.Example.Resource';
     ...
     */
    public const COL_UID = 'resource.uid';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'resource.name';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Uid', 'Name', ],
        self::TYPE_CAMELNAME     => ['uid', 'name', ],
        self::TYPE_COLNAME       => [ResourceTableMap::COL_UID, ResourceTableMap::COL_NAME, ],
        self::TYPE_FIELDNAME     => ['uid', 'name', ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Uid' => 0, 'Name' => 1, ],
        self::TYPE_CAMELNAME     => ['uid' => 0, 'name' => 1, ],
        self::TYPE_COLNAME       => [ResourceTableMap::COL_UID => 0, ResourceTableMap::COL_NAME => 1, ],
        self::TYPE_FIELDNAME     => ['uid' => 0, 'name' => 1, ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'uid' => 'UID',
        'resource.uid' => 'UID',
        'ResourceTableMap::COL_UID' => 'UID',
        'COL_UID' => 'UID',
        'Name' => 'NAME',
        'Resource.Name' => 'NAME',
        'name' => 'NAME',
        'resource.name' => 'NAME',
        'ResourceTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Db\\Example\\Resource');
        $this->setPackage('Db.Example');
        $this->setUseIdGenerator(false);
        // columns
        $this->addPrimaryKey('uid', 'Uid', 'VARCHAR', true, 255, null);
    ...
    {
        $this->addRelation('Reservation', '\\Db\\Example\\Reservation', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':resource_uid',
    1 => ':uid',
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ResourceTableMap::COL_UID);
            $criteria->addSelectColumn(ResourceTableMap::COL_NAME);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(ResourceTableMap::COL_UID);
            $criteria->removeSelectColumn(ResourceTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Db\Example\Resource) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(ResourceTableMap::DATABASE_NAME);
            $criteria->add(ResourceTableMap::COL_UID, (array) $values, Criteria::IN);
        }
