...
namespace Db\Example\Map;

use Db\Example\Reservation;
use Db\Example\ReservationQuery;
...
class ReservationTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Db.Example.Map.ReservationTableMap';
     ...
     */
    public const OM_CLASS = '\\Db\\Example\\Reservation';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Db.Example.Reservation';
     ...
     */
    public const COL_ID = 'reservation.id';

    /**
     * the column name for the resource_uid field
     */
    public const COL_RESOURCE_UID = 'reservation.resource_uid';

    /**
     * the column name for the date_from field
     */
    public const COL_DATE_FROM = 'reservation.date_from';

    /**
     * the column name for the date_to field
     */
    public const COL_DATE_TO = 'reservation.date_to';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Uid', 'DateFrom', 'DateTo', ],
        self::TYPE_CAMELNAME     => ['id', 'uid', 'dateFrom', 'dateTo', ],
        self::TYPE_COLNAME       => [ReservationTableMap::COL_ID, ReservationTableMap::COL_RESOURCE_UID, ReservationTableMap::COL_DATE_FROM, ReservationTableMap::COL_DATE_TO, ],
        self::TYPE_FIELDNAME     => ['id', 'resource_uid', 'date_from', 'date_to', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Uid' => 1, 'DateFrom' => 2, 'DateTo' => 3, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'uid' => 1, 'dateFrom' => 2, 'dateTo' => 3, ],
        self::TYPE_COLNAME       => [ReservationTableMap::COL_ID => 0, ReservationTableMap::COL_RESOURCE_UID => 1, ReservationTableMap::COL_DATE_FROM => 2, ReservationTableMap::COL_DATE_TO => 3, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'resource_uid' => 1, 'date_from' => 2, 'date_to' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'COL_ID' => 'ID',
        'Uid' => 'RESOURCE_UID',
        'Reservation.Uid' => 'RESOURCE_UID',
        'uid' => 'RESOURCE_UID',
        'reservation.uid' => 'RESOURCE_UID',
        'ReservationTableMap::COL_RESOURCE_UID' => 'RESOURCE_UID',
        'COL_RESOURCE_UID' => 'RESOURCE_UID',
        'resource_uid' => 'RESOURCE_UID',
        'reservation.resource_uid' => 'RESOURCE_UID',
        'DateFrom' => 'DATE_FROM',
        'Reservation.DateFrom' => 'DATE_FROM',
        'dateFrom' => 'DATE_FROM',
        'reservation.dateFrom' => 'DATE_FROM',
        'ReservationTableMap::COL_DATE_FROM' => 'DATE_FROM',
        'COL_DATE_FROM' => 'DATE_FROM',
        'date_from' => 'DATE_FROM',
        'reservation.date_from' => 'DATE_FROM',
        'DateTo' => 'DATE_TO',
        'Reservation.DateTo' => 'DATE_TO',
        'dateTo' => 'DATE_TO',
        'reservation.dateTo' => 'DATE_TO',
        'ReservationTableMap::COL_DATE_TO' => 'DATE_TO',
        'COL_DATE_TO' => 'DATE_TO',
        'date_to' => 'DATE_TO',
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Db\\Example\\Reservation');
        $this->setPackage('Db.Example');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addForeignKey('resource_uid', 'Uid', 'VARCHAR', 'resource', 'uid', true, 255, null);
    ...
    {
        $this->addRelation('Resource', '\\Db\\Example\\Resource', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':resource_uid',
    1 => ':uid',
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ReservationTableMap::COL_RESOURCE_UID);
            $criteria->addSelectColumn(ReservationTableMap::COL_DATE_FROM);
            $criteria->addSelectColumn(ReservationTableMap::COL_DATE_TO);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.resource_uid');
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(ReservationTableMap::COL_RESOURCE_UID);
            $criteria->removeSelectColumn(ReservationTableMap::COL_DATE_FROM);
            $criteria->removeSelectColumn(ReservationTableMap::COL_DATE_TO);
        } else {
            $criteria->removeSelectColumn($alias . '.id');
            $criteria->removeSelectColumn($alias . '.resource_uid');
            $criteria->removeSelectColumn($alias . '.date_from');
            $criteria->removeSelectColumn($alias . '.date_to');
        }
    }
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Db\Example\Reservation) { // it's a model object
