 ...
 *
 *
 * @package    propel.generator.Db.Example.Base
 */
abstract class Reservation implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Db\\Example\\Map\\ReservationTableMap';
    ...
    /**
     * The value for the resource_uid field.
     *
     * @var        string
     */
    protected $resource_uid;
    ...
    /**
     * Initializes internal state of Db\Example\Base\Reservation object.
     */
    ...
    /**
     * Get the [resource_uid] column value.
     *
     * @return string
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ReservationTableMap::COL_ID] = true;
        }
    ...
    /**
     * Set the value of [resource_uid] column.
     *
    ...
    public function setUid($v)
    {
        ...
        if ($this->resource_uid !== $v) {
            $this->resource_uid = $v;
            $this->modifiedColumns[ReservationTableMap::COL_RESOURCE_UID] = true;
        }

        if ($this->aResource !== null && $this->aResource->getUid() !== $v) {
            $this->aResource = null;
        }
    ...
    public function setDateFrom($v)
    {
        ...
        if ($this->date_from !== null || $dt !== null) {
            if ($this->date_from === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_from->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ReservationTableMap::COL_DATE_FROM] = true;
            }
    ...
    public function setDateTo($v)
    {
        ...
        if ($this->date_to !== null || $dt !== null) {
            if ($this->date_to === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_to->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ReservationTableMap::COL_DATE_TO] = true;
            }
        } // if either are not null
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ReservationTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ReservationTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->resource_uid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ReservationTableMap::translateFieldName('DateFrom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date_from = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ReservationTableMap::translateFieldName('DateTo', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = ReservationTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Db\\Example\\Reservation'), 0, $e);
        }
    }
    ...
    {
        if ($this->aResource !== null && $this->resource_uid !== $this->aResource->getUid()) {
            $this->aResource = null;
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(ReservationTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ReservationTableMap::COL_RESOURCE_UID)) {
            $modifiedColumns[':p' . $index++]  = 'resource_uid';
        }
        if ($this->isColumnModified(ReservationTableMap::COL_DATE_FROM)) {
            $modifiedColumns[':p' . $index++]  = 'date_from';
        }
        if ($this->isColumnModified(ReservationTableMap::COL_DATE_TO)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'resource_uid':
                        $stmt->bindValue($identifier, $this->resource_uid, PDO::PARAM_STR);
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(ReservationTableMap::COL_ID)) {
            $criteria->add(ReservationTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ReservationTableMap::COL_RESOURCE_UID)) {
            $criteria->add(ReservationTableMap::COL_RESOURCE_UID, $this->resource_uid);
        }
        if ($this->isColumnModified(ReservationTableMap::COL_DATE_FROM)) {
            $criteria->add(ReservationTableMap::COL_DATE_FROM, $this->date_from);
        }
        if ($this->isColumnModified(ReservationTableMap::COL_DATE_TO)) {
            $criteria->add(ReservationTableMap::COL_DATE_TO, $this->date_to);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Db\Example\Reservation (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Db\Example\Reservation Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        if ($this->aResource === null && (($this->resource_uid !== "" && $this->resource_uid !== null))) {
            $this->aResource = ChildResourceQuery::create()->findPk($this->resource_uid, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aResource->addReservations($this);
             */
        }
    ...
    {
        if (null !== $this->aResource) {
            $this->aResource->removeReservation($this);
        }
        $this->id = null;
        $this->resource_uid = null;
        $this->date_from = null;
        $this->date_to = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
